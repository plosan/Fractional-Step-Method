...
plot 'data/vel_129_129_1000_180.txt' with image, 'data/vel_129_129_1000_180.txt' using 1:2:($4/(20*sqrt(($4)**2 + ($5)**2))):($5/(20*sqrt(($4)**2 + ($5)**2))) every 10:10 with vectors lc -1 filled

replot

set terminal epslatex standalone color colortext size 12cm,12cm
set rmargin 2
set output "sec_180.tex"
replot
set output
