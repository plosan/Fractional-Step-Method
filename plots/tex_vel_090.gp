...
# --- GRAPH c
set title '\textbf{Velocity field} (Re = 1000, $t$ = 90 s)'
...
plot '../output_data/vel_129_129_1000_90.txt' with image, '../output_data/vel_129_129_1000_90.txt' using 1:2:($4/(20*sqrt(($4)**2 + ($5)**2))):($5/(20*sqrt(($4)**2 + ($5)**2))) every 10:10 with vectors lc -1 filled

replot

set terminal epslatex standalone color colortext size 15cm,12cm
set rmargin 2
set output "vel_090.tex"
replot
set output
